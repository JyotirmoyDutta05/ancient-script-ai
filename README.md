Ancient Script AI – Sanskrit OCR - Translation Pipeline
Overview
...
Itihāsa and classical Sanskrit texts

Parallel Sanskrit–English corpora
...
Commercial usage requires appropriate licensing for OCR and model components.
